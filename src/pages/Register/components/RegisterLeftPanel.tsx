export function RegisterLeftPanel() {
  return (
    <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-[#D4EAFC] via-[#E9F3FF] to-[#E3F4E6] dark:from-neutral-800 dark:to-neutral-900 p-8 lg:p-10 xl:p-12 flex-col justify-between relative overflow-hidden h-full">
      {/* Logo and Title */}
      <div className="z-10">
